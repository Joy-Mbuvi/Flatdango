...
// function reduceavailabletickets('http://localhost:3000/films/${movi.id}'){
//     method: "PATCH",
//     headers: {
...
function updatebtn(){
    ...
    alert("Please note that on every click you are updating the server and its not reversible. so ukifanya test keep track ya movie umeselect")
